...
<ul class="navbar-nav">
<li class="list-home">
  <a class="nav-link1 btn btn-success" href="index.php">HOME</a>
  <style>
            ...
            <div class="row">
                ...
                ?>
                    <tr>
                        ...
                        <td><a href="users.php?id= <?php echo $rows['id'] ;?>"> <button type="button" class="button btn btn-warning">Transfer</button></a></td>
                    </tr>
                <?php
                    }
                ?>
